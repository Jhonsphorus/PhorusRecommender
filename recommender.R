...
movie_recommendation <- function(input1,input2,input3,input4,input5,input6) {
  ...
  # rows = 4841 (number of movies) and column = 132 (Number of user) - The values i have reduced them to
  userSelect <- matrix(NA,4841) # Creating a matrix of the same number of columns(movies =132) as we have in movies2
